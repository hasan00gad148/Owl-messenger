        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.profile:
                        Intent i1 = new Intent(getApplicationContext(),MainActivityforprofile.class);
                        i1.putExtra("USER_ID",bundle.getInt("USER_ID"));
                        startActivity(i1);
                        Toast.makeText(getApplicationContext(), "Friends List", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.friends_list:
                            Intent i2 = new Intent(getApplicationContext(),FriendsListActivity.class);
                    ...
                    case R.id.received_messages:
                        ...
                        i3.putExtra("RECEIVED",true);
                        startActivity(i3);
                        Toast.makeText(getApplicationContext(), "Received Messages", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.sent_messages:
                        Intent i4 = new Intent(getApplicationContext(),MassagesListActivity.class);
                        i4.putExtra("USER_ID",bundle.getInt("USER_ID"));
                        i4.putExtra("RECEIVED",false);
                        startActivity(i4);
                        Toast.makeText(getApplicationContext(), "Sent Messages", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.send_messages:
                        Intent i5 = new Intent(MainActivity.this, sendMessages.class);
                        i5.putExtra("USER_ID",bundle.getInt("USER_ID"));
                        startActivity(i5);
                        break;
                    case R.id.add_friend:
                        Intent i6 = new Intent(MainActivity.this, AddFriend.class);
                        i6.putExtra("USER_ID",bundle.getInt("USER_ID"));
                        startActivity(i6);
                        break;
                    case R.id.add_friend:
                        Intent i7 = new Intent(MainActivity.this, MainActivity.class);
                        i7.putExtra("USER_ID",bundle.getInt("USER_ID"));
                        startActivity(i7);
                        break;
                    case R.id.log_out:
